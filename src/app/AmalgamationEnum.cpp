...
namespace Codec
{
CodecEnum::EnumData CodecEnum::mSortedByEnum[13 + 1] = {CodecEnum::EnumData(bc1, "bc1"),                       //
...
CodecEnum::EnumData CodecEnum::mSortedByString[13 + 1] = {CodecEnum::EnumData(bc1, "bc1"),                       //
                                                          CodecEnum::EnumData(bc3, "bc3"),                       //
                                                          CodecEnum::EnumData(bc4, "bc4"),                       //
                                                          CodecEnum::EnumData(bc4_snorm, "bc4_snorm"),           //
                                                          CodecEnum::EnumData(bc5, "bc5"),                       //
...
{
  bool operator()(const CodecEnum::EnumData &_l, Codec _r) const
  {
    return _l.enumValue < _r;
  }

  bool operator()(Codec _l, const CodecEnum::EnumData &_r) const
  {
    return _l < _r.enumValue;
  }

  bool operator()(const CodecEnum::EnumData &_l, int _r) const
  {
    return _l.enumValue < _r;
  }

  bool operator()(int _l, const CodecEnum::EnumData &_r) const
  {
    return _l < _r.enumValue;
  }
};
...
//---------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------
int CodecEnum::minValue()
{
  return mSortedByEnum[0].enumValue;
}
//---------------------------------------------------------------------------------------
int CodecEnum::maxValue()
{
  return mSortedByEnum[13 - 1].enumValue;
}
//---------------------------------------------------------------------------------------
size_t CodecEnum::count()
{
  return 13;
}
//---------------------------------------------------------------------------------------
...
{
  const EnumData *itor = std::lower_bound(&mSortedByString[0], &mSortedByString[13], strValue, OrderByStr());
...
//---------------------------------------------------------------------------------------
bool CodecEnum::isValidValue(int value)
{
...
//---------------------------------------------------------------------------------------
const std::string &CodecEnum::find(Codec value)
{
  return get(value);
}
} // namespace Codec
