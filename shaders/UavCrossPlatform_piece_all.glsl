...
#define OGRE_imageWrite2D1( outImage, iuv, value ) \
	imageStore( outImage, int2( iuv ), float4( value, 0, 0, 0 ) )
#define OGRE_imageWrite2D2( outImage, iuv, value ) \
	imageStore( outImage, int2( iuv ), float4( value, 0, 0 ) )
